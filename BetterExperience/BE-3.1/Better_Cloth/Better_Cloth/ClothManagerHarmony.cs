...
internal static class ClothManagerHarmony
{
	...
	[HarmonyPostfix]
	public static void After_ConjuntoDeRopaLoader_OcultarPieza(PiezasDeRopaLoader __instance, int piezaId, bool ocultar, ref PiezaDeRopaBase paraCambiarEstado, bool __result)
	{

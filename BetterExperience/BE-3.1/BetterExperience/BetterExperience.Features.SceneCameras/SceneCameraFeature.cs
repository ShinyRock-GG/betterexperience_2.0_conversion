...
internal class SceneCameraFeature : PluginFeature
{
	...
	public override void OnInit()
	{
		...
		pluginOptionsService.Expose(configEnableSceneCamera, base.Scope);
		pluginOptionsService.Expose(enableRagdollRaycastPivot, base.Scope);
		pluginOptionsService.Expose(enablePivotLinecast, base.Scope);
		if (sceneCamMode)
		{
			pluginOptionsService.Expose(enableQuickCam, base.Scope);
		}
		pluginOptionsService.Expose(configKeyForward, base.Scope);
		pluginOptionsService.Expose(configKeyBackward, base.Scope);
		pluginOptionsService.Expose(configKeyLeft, base.Scope);
		pluginOptionsService.Expose(configKeyRight, base.Scope);
		pluginOptionsService.Expose(configKeyUp, base.Scope);
		pluginOptionsService.Expose(configKeyDown, base.Scope);
		if (sceneCamMode)
		{
			pluginOptionsService.Expose(configKeyEditCam, base.Scope);
			pluginOptionsService.Expose(configKeySwitchCam, base.Scope);
			pluginOptionsService.Expose(configKeySaveCam, base.Scope);
			pluginOptionsService.Expose(configKeyDelCam, base.Scope);
		}
	}

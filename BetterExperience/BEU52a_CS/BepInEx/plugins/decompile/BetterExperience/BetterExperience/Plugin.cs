...
[BepInPlugin("f95.betterexperience", "Better Experience Mod", "1.5.2")]
...
public class Plugin : BaseUnityPlugin
{
	...
	private IEnumerator AsyncStart()
	{
		...
		StartServices();
		sw.Stop();
		((BaseUnityPlugin)this).Logger.LogInfo((object)("BetterExperience started in " + sw.ElapsedMilliseconds + "ms"));
	}

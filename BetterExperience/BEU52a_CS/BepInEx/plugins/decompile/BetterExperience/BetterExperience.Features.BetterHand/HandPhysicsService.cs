...
internal class HandPhysicsService : SessionService
{
	...
	{
		ListDictionary<CollisionTracker.CollisionKey, List<ContactPoint>> tmp = new ListDictionary<CollisionTracker.CollisionKey, List<ContactPoint>>();

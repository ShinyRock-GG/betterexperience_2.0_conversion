...
internal class SMAGlobalPatches
{
	...
	[HarmonyPatch(typeof(EntrevistaConFemaleDePoolDelDia), "CalificarCurrentFemale")]
	[HarmonyPrefix]
	public static void PanelDeEntrevistaCalificacion_CalificarCurrentFemale(EntrevistaConFemaleDePoolDelDia __instance)
	{
		if (_afterAutorating)
		{
			AfterAutorating.Invoke(__instance.flagScoreAparienciaCurrentFemaleV2, __instance.flagScorePersonalidadCurrentFemaleV2);
		}

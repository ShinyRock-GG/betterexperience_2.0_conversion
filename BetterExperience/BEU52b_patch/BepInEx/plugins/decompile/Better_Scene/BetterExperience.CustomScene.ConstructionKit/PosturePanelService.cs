...
internal class PosturePanelService : SessionService
{
	...
	{
		PoseAnimationController.ApplySkeletonConfiguration(interactionManager.AnimationController, posture.Configuration, ((Character)(object)base.Session.Guest.Impl).animatorRootMotionTransform, Vector3.zero, Quaternion.identity, 0.2f);
	}
}
